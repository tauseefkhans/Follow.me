...
\033[1;91m  ♦♦♦CONTACT FACEBOOK /@mtauseef.khanx♦♦♦
...
jalan("   \033[1;91m Tausifo ༆°᭄ ")

jalan("   \033[1;91m THIS IS JUST FOR EDUCATION PURPOSE FOR ILLEGAL IM NOT RESPONSIBLE  ")	

jalan("   \033[1;91m WIFI AND LOW SINGNAL USERZ USE ANY PROXY ")	

jalan("   \033[1;93m Welcome To ༆°᭄TAUSIFO Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mBlacktiger\033[1;96m•◈•──────────•◈•")

CorrectUsername = "TAUSIFO"

CorrectPassword = "KHANO"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://www.facebook.com/mtauseef.khanx
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update TAUSIFO "																														
...
def pilih_super():
	...
	jalan('                    \033[1;97m ༆°᭄TAUSIFO cloning Started Wait...')
...
\033[1;31;40m ●════════════════════════◄ Thanks To @TAUSIFO KHANO ►════════════════════════●
